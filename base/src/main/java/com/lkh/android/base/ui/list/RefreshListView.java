 ...
 */
package com.lkh.android.base.ui.list;
...
public class RefreshListView extends ListView implements OnScrollListener {
        ...
        default:
            ...
            if (getFirstVisiblePosition() == 0) {
                ...
                if (mEnablePullRefresh
                    ...
                    mHeaderView.setState(ListViewHeader.RefreshState.STATE_REFRESHING);
    ...
    private void updateHeaderHeight(float delta) {
        ...
        if (mEnablePullRefresh && !mPullRefreshing) { // 未处于刷新状态，更新箭头
            if (mHeaderView.getVisibleHeight() > mHeaderViewHeight) {
                mHeaderView.setState(ListViewHeader.RefreshState.STATE_READY);
            } else {
                mHeaderView.setState(ListViewHeader.RefreshState.STATE_NORMAL);
            }
        }
    ...
    private void updateFooterHeight(float delta) {
        ...
        if (mEnablePullLoad && !mPullLoading) {
            if (height > PULL_LOAD_MORE_DELTA) {
                // 上拉足够高时，加载更多
                mFooterView.setState(ListViewFooter.LoadMoreState.STATE_READY);
            } else {
                mFooterView.setState(ListViewFooter.LoadMoreState.STATE_NORMAL);
            }
        }
    ...
    private void startLoadMore() {
        mPullLoading = true;
        mFooterView.setState(ListViewFooter.LoadMoreState.STATE_LOADING);
        if (mListViewListener != null) {
     ...
     */
    public static interface OnKJScrollListener extends OnScrollListener {
